...
class CommentairesControllerTest < ActionController::TestCase
  ...
  test "should create commentaire" do
    assert_difference('Commentaire.count') do
      post :create, commentaire: { article_id: @commentaire.article_id, date_commentaire: @commentaire.date_commentaire, texte_commentaire: @commentaire.texte_commentaire, utilisateur_id: @commentaire.utilisateur_id }
    end
  ...
  test "should update commentaire" do
    patch :update, id: @commentaire, commentaire: { article_id: @commentaire.article_id, date_commentaire: @commentaire.date_commentaire, texte_commentaire: @commentaire.texte_commentaire, utilisateur_id: @commentaire.utilisateur_id }
    assert_redirected_to commentaire_path(assigns(:commentaire))
  end
